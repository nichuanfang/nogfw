...
def interval_func(channel:dict[str,str],number:int,sleeptime:int):
    """频道处理逻辑

    Args:
        channel (str): 频道详情 key:youtuber名称 value:频道id
        number(int): 爬取次数
        sleeptime(int): 间隔时间
    ...
    for youtuber in channel:
        # 频道id
        channel_id = channel[youtuber]
